...
export class WishlistService {
  ...
  async createWishlist(tenant_id: string, dto: CreateWishlistDto) {
    try {
      ...
      throw new HttpException('Failed to create wishlist', 500);
    }
  }
  ...
  async getTenantWishlists(tenant_id: string) {
    try {
      ...
      throw new HttpException('Failed to fetch wishlists', 500);
    }
  }
  ...
  async addPropertyToWishlist(wishlist_id: string, dto: AddPropertyDto) {
    try {
      ...
      throw new HttpException('Failed to add properties to wishlist', 500);
    }
  }
  ...
  async removePropertyFromWishlist(wishlist_id: string, property_id: string) {
    try {
      ...
      throw new HttpException('Failed to remove property from wishlist', 500);
    }
  }
  ...
  async removePropertiesFromWishlist(wishlist_id: string, property_ids: string[]) {
    try {
      ...
      throw new HttpException('Failed to remove properties from wishlist', 500);
    }
  }
  ...
  async renameWishlist(wishlist_id: string, newName: string) {
    try {
      ...
      throw new HttpException('Failed to rename wishlist', 500);
    }
  }
  ...
  async deleteMultipleWishlists(wishlist_ids: string[]) {
    try {
      ...
      throw new HttpException('Failed to delete wishlists', 500);
    }
  }
  ...
  async moveProperty(dto: MovePropertyDto) {
    try {
      ...
      throw new HttpException('Failed to move properties between wishlists', 500);
    }
  }
  ...
  async getWishlistById(wishlist_id: string, page_number = 1, page_size = 10) {
    try {
      ...
      throw new HttpException('Failed to fetch wishlist details', 500);
    }
  }
