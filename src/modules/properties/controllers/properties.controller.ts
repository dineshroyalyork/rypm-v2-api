...
import { Body, Controller, Get, Param, Post, Req, UseGuards, UploadedFile, ParseFilePipe, UseInterceptors, Query, UsePipes } from '@nestjs/common';
...
export class PropertiesController {
  ...
  async getAllProperties(@Query() query: any, @Req() req: Request) {
    ...
    const { bedrooms, bathrooms, parking, min_price, max_price, search, property_type, move_in_date, latitude, longitude, radius } = query;
